...
export const UserSignUp = () => {
  ...
  function submit() {
    ...
    axios
      .post(`${process.env.REACT_APP_API_URL}/api/v1/auth/user/signup/1`, {
        name: data.name,
        email: data.email,
      ...
      .then((result) => {
        ...
        setTimeout(function() { window.location = "/user-login"; }, 1000);
      })
      .catch((err) => {
    ...
    <ConfigProvider theme={customAntdStyle}>
      ...
      <div className="user-sign-up">
        ...
        <p className="to-be-a-vendor-sign">
          ...
          <a href="/vendor-signup"><span className="design-component-instance-node">Sign Up</span></a>
        </p>
        <img
          className="chris-lee"
          alt="Chris lee"
